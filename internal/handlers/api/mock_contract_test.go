...
func (m *MockSocietyService) GetAccessLevel(r *http.Request) (*society_proto.GetAccessLevelOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccessLevel", r)
	ret0, _ := ret[0].(*society_proto.GetAccessLevelOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccessLevel indicates an expected call of GetAccessLevel.
func (mr *MockSocietyServiceMockRecorder) GetAccessLevel(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccessLevel", reflect.TypeOf((*MockSocietyService)(nil).GetAccessLevel), r)
}

// GetPermission mocks base method.
func (m *MockSocietyService) GetPermission(r *http.Request) (*society_proto.GetPermissionsOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPermission", r)
	ret0, _ := ret[0].(*society_proto.GetPermissionsOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetPermission indicates an expected call of GetPermission.
func (mr *MockSocietyServiceMockRecorder) GetPermission(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockSocietyService) SubscribeToSociety(r *http.Request) (*society_proto.SubscribeToSocietyOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SubscribeToSociety", r)
	ret0, _ := ret[0].(*society_proto.SubscribeToSocietyOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SubscribeToSociety indicates an expected call of SubscribeToSociety.
func (mr *MockSocietyServiceMockRecorder) SubscribeToSociety(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SubscribeToSociety", reflect.TypeOf((*MockSocietyService)(nil).SubscribeToSociety), r)
}

// UnsubscribeFromSociety mocks base method.
func (m *MockSocietyService) UnsubscribeFromSociety(r *http.Request) (*society_proto.UnsubscribeFromSocietyOut, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UnsubscribeFromSociety", r)
	ret0, _ := ret[0].(*society_proto.UnsubscribeFromSocietyOut)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// UnsubscribeFromSociety indicates an expected call of UnsubscribeFromSociety.
func (mr *MockSocietyServiceMockRecorder) UnsubscribeFromSociety(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UnsubscribeFromSociety", reflect.TypeOf((*MockSocietyService)(nil).UnsubscribeFromSociety), r)
}
