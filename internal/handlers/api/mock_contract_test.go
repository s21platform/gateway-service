...
func (m *MockSocietyService) RemoveSociety(r *http.Request) (*society_proto.EmptySociety, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RemoveSociety", r)
	ret0, _ := ret[0].(*society_proto.EmptySociety)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// RemoveSociety indicates an expected call of RemoveSociety.
func (mr *MockSocietyServiceMockRecorder) RemoveSociety(r interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RemoveSociety", reflect.TypeOf((*MockSocietyService)(nil).RemoveSociety), r)
}
